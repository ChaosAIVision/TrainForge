...
class HuggingFaceVLMModelLoader(BaseModelLoader):
    """HuggingFace model loader for VLM."""
    
    def load_model_and_tokenizer(self, config: ModelConfig) -> Tuple[PreTrainedModel, PreTrainedTokenizer]:
        """Load VLM model and processor using HuggingFace."""
...
class HuggingFaceVLMSFTTrainer:
    """HuggingFace VLM SFT Trainer with production-ready architecture."""
    ...
    def setup_model(self):
        """Load and setup VLM model and processor."""
        model_loader = HuggingFaceVLMModelLoader()
        self.model, self.processor = model_loader.load_model_and_tokenizer(self.model_config)
    ...
    def setup_trainer(self):
        ...
        training_args = TrainingArguments(
            ...
            max_steps=self.hyperparams_config.max_steps,
            learning_rate=self.hyperparams_config.learning_rate,
            fp16=self.hyperparams_config.fp16,
            bf16=self.hyperparams_config.bf16,
        ...
        self.trainer = SFTTrainer(
            ...
            dataset_text_field=self.dataset_config.text_field,
    ...
    def train(self) -> Dict[str, Any]:
        ...
        if self.accelerator.is_main_process:
            print("HuggingFace VLM Training completed successfully")
